...
/**
 * A minimal synthetic request for space-level CPS routing (`searchRouting: 'space'`) in
...
/**
 * A request that carries a URL, accepted by `asScoped` when `searchRouting: 'space'` is used.
 *
